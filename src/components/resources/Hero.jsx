  ...
  return (
    <div className="w-full h-[70vh]  relative mt-20">
      ...
      <div className="relative z-10 flex flex-col items-start py-40 h-auto px-5 md:px-15">
        ...
        <h2 className="mt-3 md:mt-0 text-white text-xl font-bold drop-shadow-2xl md:font-extrabold md:text-3xl text-center md:text-start md:max-w-full mx-auto leading-tight">
